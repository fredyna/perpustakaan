 ...
 * @author fredd
 */
public class UbahBuku extends javax.swing.JDialog {
    private String id_buku;

    /**
     * Creates new form TambahBuku
     */
    public UbahBuku(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadSupplier();
        fillForm();
    ...
    public UbahBuku(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
        this.id_buku = id;
        loadSupplier();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UbahBuku dialog = new UbahBuku(new javax.swing.JFrame(), true);
